...
PROJECT_DIR = os.path.join(BASE_DIR, "movieguessr")
...
SECRET_KEY = "django-very-insecure-dev-key"
...
MIDDLEWARE = [
    ...
    # 'django.middleware.csrf.CsrfViewMiddleware', NOT SECURE AND ACTUAL RISK BECAUSE THIS IS DISABLED
